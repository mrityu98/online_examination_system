...
<head>
    ...
    <link rel="stylesheet" href="css/teacher-profile-style.css">
                                ...
                                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <form action="{{ route('teacher_profilee') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="col-mb-3">
                                            @foreach($data as $data)
                                                <form action="{{ url('tea_image_update/'.$data->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <label for="formFileSm" class="form-label">Select Image File(*.jpg, *.jpeg, *.png)</label>
            ...
            <div class="modal fade" id="modalLoginForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form class="form" action="{{ url('update_teacher_data/'.Auth::user()->id) }}" method = "POST">
                            @csrf 
                            @method('PUT')
                            <div class="form-group">
                                <label for="name">Full Name:</label>
                                <input class="form-control" id="name" name="name" value="{{ Auth::user()->name }}" type="text" pattern="[a-zA-Z\s]+" required="" autofocus="" title="Username should only contain letters. e.g. Piyush Gupta" autocomplete="" placeholder="Type your name here...">
                            </div>
                            <div class="form-group">
                                <label for="email">Email address:</label>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="department" value="{{ Auth::user()->department }}" id="designation" required="" placeholder="Type your class...">
                            </div>
                            <div class="form-group">
                                <label for="dob">Date of Birth:</label>
                                <input class="form-control" type="date" name="dob" id="dob" value="{{ Auth::user()->dob }}" required="" placeholder="Type your Date of Birth...">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="text-right">
                                <a href=""><button class="movebtn movebtnre" type="Reset"><ion-icon name="refresh-outline"></ion-icon> Reset </button></a>
                                <a href=""><button class="movebtn movebtnsu" type="Submit">Submit <ion-icon name="paper-plane-outline"></ion-icon></button></a>
                            </div>
                        </form>
