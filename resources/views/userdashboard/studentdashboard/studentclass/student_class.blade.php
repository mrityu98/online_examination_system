...
<body>
    <div class="containerr">
        ...
        <div class="main active">
            ...
            <!-- subjects -->
            <div class="subject">
                <div class="subject_management-header kpk">
                    You are assgined to this class  
                    <h1>Year: {{Auth::user()->year}}  </h1>
                    <h1>Department: {{Auth::user()->department}} </h1>
                    <h1>Semester: {{Auth::user()->semester}} </h1>
                </div>
            </div>
        </div>
