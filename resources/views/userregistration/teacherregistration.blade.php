          ...
          <div class="col-md-8">
              <div class="card">
                  ...
                  <form action="{{ route('register.post') }}" method="POST">
                          ...
                          <div class="form-group row">
                              <label for="mobile" class="col-md-4 col-form-label text-md-right">Roll No</label>
                              <div class="col-md-6">
                                    <select class="form-control"  name="roll" required autofocus>
                                        <option value="" selected disabled>Choose Your Option</option>
                                        <option value="NULL">NULL</option> 
                                    </select>
                              </div>
                          ...
                          <div class="form-group row">
                              <label for="roll" class="col-md-4 col-form-label text-md-right">Address </label>
                              <div class="col-md-6">
